...
정적 프론트엔드와의 API 통신을 통해  
웹 애플리케이션의 전체 흐름을 구현하는 데 중점을 두었습니다.

---

## 1. Project Overview

이 프로젝트는 할 일(Todo)의 생성, 조회, 수정, 상태 변경, 삭제 기능을 제공하는  
웹 기반 Todo 관리 애플리케이션입니다.

Spring Boot의 자동 설정(Auto Configuration)을 활용해 REST API를 설계·구현하고,  
...
### Todo List (Dark Mode)
> 다크모드가 적용된 메인 화면 (사용자 설정 유지)

![Todo List Dark](./screenshots/todo-list-dark.png)
